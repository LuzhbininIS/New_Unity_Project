...
public class MainMenuManager : MonoBehaviour
{
    ...
    private void TweenInNewPage(MenuPage page)
    {
        ...
        newMenu.transform.localScale = new Vector3(0.0f, 1.0f, 1.0f);
        LeanTween.scaleX(newMenu, 1.0f, tweeningTime).setDelay(tweeningTime).setOnComplete(() => { currentMenu = newMenu; });
    }
}
